 ...
 * </p>
 * <ul>
 *   <li>{@link com.dsdl.dSDL.impl.IntegerImpl#getInteger <em>Integer</em>}</li>
 *   <li>{@link com.dsdl.dSDL.impl.IntegerImpl#getLength <em>Length</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntegerImpl extends TypeImpl implements com.dsdl.dSDL.Integer
{
  /**
  ...
  {
    return DSDLPackage.Literals.INTEGER;
  }
  ...
  public void setInteger(String newInteger)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DSDLPackage.INTEGER__INTEGER, oldInteger, integer));
  }
  ...
  public void setLength(int newLength)
  {
    ...
    length = newLength;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DSDLPackage.INTEGER__LENGTH, oldLength, length));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DSDLPackage.INTEGER__INTEGER:
        return getInteger();
      case DSDLPackage.INTEGER__LENGTH:
        return getLength();
    }
